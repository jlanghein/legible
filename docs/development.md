...
```bash
git clone git@github.com:jlanghein/legible.git
cd legible
uv sync --extra dev
```
...
The binding rules are in [`AGENTS.md`](https://github.com/jlanghein/legible/blob/main/AGENTS.md).
The short version:
...
There are three at runtime: `pymupdf`, `pytesseract`, `pillow`. A fourth needs a reason
