...
Three at runtime: `pymupdf`, `pytesseract`, `pillow`. Adding a fourth needs a reason in
the commit message.
...
This library reads local files and shells out to Tesseract. It holds no credentials and
should never acquire any.
